...
func (h *IncidentHandler) Create(w http.ResponseWriter, r *http.Request) {
	...
	inc := models.Incident{
		...
		CountyID:    func() string { if sc!=nil { return sc.CountyID }; return "" }(),
		CountyName:  func() string { if sc!=nil { return sc.CountyName }; return "" }(),
		SubCountyID: func() string { if sc!=nil { return sc.SubCountyID }; return "" }(),
		SubCountyName: func() string { if sc!=nil { return sc.SubCountyName }; return "" }(),
